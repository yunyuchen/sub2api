export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for spool end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for spool end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, spool temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on spool orders; the upstream type is sent as EasyPay type.',
