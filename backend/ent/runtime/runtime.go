...
func init() {
	...
	// userDescLeaderboardNamedParticipation is the schema descriptor for leaderboard_named_participation field.
	userDescLeaderboardNamedParticipation := userFields[16].Descriptor()
	// user.DefaultLeaderboardNamedParticipation holds the default value on creation for the leaderboard_named_participation field.
	user.DefaultLeaderboardNamedParticipation = userDescLeaderboardNamedParticipation.Default.(bool)
