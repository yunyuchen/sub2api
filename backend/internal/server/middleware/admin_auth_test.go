...
func (s *stubUserRepo) GetUserAvatarsByUserIDs(ctx context.Context, userIDs []int64) (map[int64]*service.UserAvatar, error) {
...
func (s *stubUserRepo) GetByIDs(context.Context, []int64) ([]service.User, error) {
	return nil, nil
}
